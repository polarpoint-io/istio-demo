...
import io.polarpoint.notification.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link io.polarpoint.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
