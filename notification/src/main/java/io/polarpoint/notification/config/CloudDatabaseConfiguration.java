package io.polarpoint.notification.config;
...
@Configuration
@EnableMongoRepositories("io.polarpoint.notification.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.polarpoint.notification.config.dbmigrations");
