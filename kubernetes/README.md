...
```
$ docker image tag store image.polarpoint.io/store
$ docker push image.polarpoint.io/store
$ docker image tag invoice image.polarpoint.io/invoice
$ docker push image.polarpoint.io/invoice
$ docker image tag notification image.polarpoint.io/notification
$ docker push image.polarpoint.io/notification
$ docker image tag product image.polarpoint.io/product
$ docker push image.polarpoint.io/product
```
...
```
$ kubectl get svc store -n dev-hih-01
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n dev-hih-01
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n dev-hih-01
```
